...
import net.slipp.www.api.repository.board.BoardCategoryRepository;
...
public class BoardCreateService {
	...
	@Autowired
	public BoardCreateService(BoardRepository boardRepository, BoardCategoryRepository boardCategoryRepository,
	...
	public Board create(BoardDto.Create create) throws BoardCategoryNotFoundException {
		...
		BoardCategory category = boardCategoryRepository.findById(create.getCategoryNo())
				.orElseThrow(BoardCategoryNotFoundException::new);
	...
	public Board modify(Long id, BoardDto.Modify modify) throws BoardNotFoundException, BoardCategoryNotFoundException {
		...
		BoardCategory category = boardCategoryRepository.findById(modify.getCategoryNo())
				.orElseThrow(BoardCategoryNotFoundException::new);
